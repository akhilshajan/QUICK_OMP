...
subroutine outputCopyright(io,ierr)
   ...
   write(io,'(A107)') " Manathunga, M.; Jin, C.; Cruzeiro, V.W.D.; Smith, J.; Keipert, K.; Pekurovsky, D.; Mu, D.; Miao, Y.;     "
   write(io,'(A107)') " He, X.; Ayers, K.; Brothers, E.; Goetz, A.W.; Merz, K.M. QUICK-21.03                                     "
   write(io,'(A107)') " University of California San Diego, CA and Michigan State University, East Lansing, MI, 2021             "
   write(io,'(A107)') "                                                                                                          "
