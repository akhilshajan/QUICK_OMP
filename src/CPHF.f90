...
subroutine xc_fock
  ...
  !  This allows the calculation of the derivative of the functional with regard
  !  to the 
  !  density (dfdr), with regard to the alpha-alpha density invariant (df/dgaa),
  !  and the
